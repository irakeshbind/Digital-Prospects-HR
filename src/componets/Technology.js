  ...
  return (
    <div className="w-full px-4 sm:px-6 md:px-10 lg:px-16 py-10">
      ...
      ">
        ...
        {/* Technology Card */}
        <div className="p-6 bg-amber-50 rounded-xl shadow-md border-b-[6px] border-red-700">
          <div className="w-20 h-20 bg-red-200 rounded-lg flex items-center justify-center mb-6">
